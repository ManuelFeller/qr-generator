...
/* end of QrEncoder Javascript library for QrCode generation code */
...
const codeEncoder = new QrEncoder();
const bitMatrix = codeEncoder.encode(inputArea.value.trim(), errorCorrectionSelect.value);
